...
namespace MyMusicStashWeb.Models
{
    public class Song
    {
        ...
        public Song(int accountID, string music_type, string music_name, string artist_name, string album_name, DateTime music_date, string music_Source, string music_extension)
        {
            this.accountID = accountID;
            Music_type = music_type;
            Music_name = music_name;
